...
const Laing = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* Recipe Content */}
      <Text style={styles.title}>LAING (The Quintessential Bicolano Dish)</Text>
      ...
      {/* Picture Credit */}
      <Text style={styles.pictureCredit}>“Laing” by MarvinBikolano, licensed under CC BY-SA 4.0.</Text>
