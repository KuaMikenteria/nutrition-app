...
const PiliNutCandies = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Image 
                    source={require('../../../assets/images/recipes/Pili-Nut-Candies.jpg')} // Correct way to load local images
                    style={styles.recipeImage} 
            />
      
      {/* Picture Credit */}
      <Text style={styles.pictureCredit}>“Pili Nut” by deejaymarlon, licensed under CC BY-NC-ND 2.0.</Text>
